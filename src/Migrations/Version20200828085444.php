 ...
 */
final class Version20200828085444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exact_locker (id INT AUTO_INCREMENT NOT NULL, locker TINYINT(1) NOT NULL, version INT NOT NULL, timestamp INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
    }
